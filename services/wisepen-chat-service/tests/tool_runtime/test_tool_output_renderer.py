...
from chat.application.tools.tool_output_renderer import _regular_return_parts, render_tool_xml
...
def test_regular_return_none_keeps_empty_root() -> None:
    visible_result, rendered = _regular_return_parts(root_tag="result", value=None)
