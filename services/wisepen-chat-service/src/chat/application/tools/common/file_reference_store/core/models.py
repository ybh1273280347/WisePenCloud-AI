...
class ResolvedFileReference:
    """已完成作用域和文件完整性校验的引用解析结果。"""

    ref_id: str  # 已解析的 file_* 引用标识
...
@dataclass(frozen=True, slots=True)
class FileReferenceCleanupResult:
