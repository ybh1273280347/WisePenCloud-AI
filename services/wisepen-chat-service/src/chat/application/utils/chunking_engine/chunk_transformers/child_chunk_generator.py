...
class ChildChunkGenerator:
    ...
    def __init__(self, config: ChildChunkConfig | None = None) -> None:
        self.config = config or ChildChunkConfig()
        self.name = "child_chunk_generator"
