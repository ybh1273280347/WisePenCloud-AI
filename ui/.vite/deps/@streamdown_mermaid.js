...
import {
  JSON_SCHEMA,
  load
} from "./chunk-VSPPPUVH.js";
import {
  registerLayoutLoaders
} from "./chunk-CNN6SZLY.js";
import "./chunk-B5UU7KYP.js";
import "./chunk-MI7NPAMO.js";
import "./chunk-GJNPK2BY.js";
import "./chunk-HQRLIROH.js";
import "./chunk-JZ4BR76B.js";
import "./chunk-SMNJZ2Y3.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-FFBC4E25.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-AAUBKEIU-7ZJTMRD6.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-JILLDUNU.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-TEJ5UH35-EESVNE3R.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-ABHIARB6.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-6RSMTGT7-3LARGVRG.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-PDCA5V65.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-EDDQCZZX.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-W4KKPZXB-IP4PFJEH.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-2RQKCTM6-DQPOFQZP.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-4Y6WPE33-ZA5MOINC.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-7UZHMZWN.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-4FO5ZUOK-RUUE2LBT.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-Q7XG4LA2-2BTPTTHX.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-AJRCARHV-U3JODRBL.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-BHNVJYJU-UKZEASES.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-JHISSGLW-QCWKFLDV.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-PNZ67QCA-YUBT34MJ.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-RKZ34NQL-GBHWXGII.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-ZENSRG52.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-5OEKKPKP-K4RVFLH3.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-LMA3HP47-TWPXQAME.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-ZUY4UJ5K.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-GPEHLZMM-UCEMN5D5.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-A6VQA5AB.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-TUYGI2FB.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-SGDKX6VX.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-YF4QCWOH-D3SPCY6F.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-CIIHVFJN-ZXT2B22G.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-K3TNHODE.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-FGBQQIHO.js");
...
// node_modules/@streamdown/mermaid/dist/index.js
var m = { startOnLoad: false, theme: "default", securityLevel: "strict", fontFamily: "monospace", suppressErrorRendering: true };
function o(a = {}) {
  let e = false, r = { ...m, ...a.config }, t = { initialize(i) {
    r = { ...m, ...a.config, ...i }, mermaid_default.initialize(r), e = true;
  }, async render(i, g) {
    return e || (mermaid_default.initialize(r), e = true), await mermaid_default.render(i, g);
  } };
  return { name: "mermaid", type: "diagram", language: "mermaid", getMermaid(i) {
    return i && t.initialize(i), t;
  } };
}
var f = o();
export {
  o as createMermaidPlugin,
  f as mermaid
};
//# sourceMappingURL=@streamdown_mermaid.js.map
